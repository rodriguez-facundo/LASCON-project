# by F. Rodriguez  frodriguez4600@gmail.com
#
# COMMENTS
# --------
...
def importSections():
    ...
    # granule cell dendrite section, divided in two groups: proximal
    # dendrites and distal dendrites. It will be used later to select
    # target sections.
